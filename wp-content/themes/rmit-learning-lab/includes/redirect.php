...
?>
 ...
 // References to DOM objects
  ...
  <script type="text/javascript" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/js/search-home.js?v=<?php echo esc_attr( rmit_learning_lab_asset_version( 'js/search-home.js' ) ); ?>"></script>
