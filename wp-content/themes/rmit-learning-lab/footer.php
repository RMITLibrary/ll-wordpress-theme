      ...
      <div class="row">
        <div class="col">
          <section class="acknowledgement-container">
            <div class="content">
              <img alt="aboriginal flag" src="https://www.rmit.edu.au/content/dam/rmit/au/en/news/homepage/flag-red.png" width="114" height="76" loading="lazy" decoding="async" />
              <img alt="torres strait flag" src="https://www.rmit.edu.au/content/dam/rmit/au/en/news/homepage/flag-green.png" width="114" height="76" loading="lazy" decoding="async">
          ...
          <div class="footerlegalShareItems">
            ...
            <div class="social-nav">
              <ul>
                ...
                <!-- END facebook -->
                <!-- START twitter/x -->
                <li><a aria-label="For Twitter" href="https://twitter.com/rmit"> <span class="no-focus" tabindex="-1"><img src="https://rmitlibrary.github.io/cdn/image/svg/social/twitter.svg" alt="" loading="lazy" decoding="async" /></span></a></li>
                <!-- END twitter/x -->
                <!-- START insta -->
